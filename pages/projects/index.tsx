  ...
  return (
    <LayoutHeader headTitle="Christoffer Granstedt - Projects" headDescription="Some of the projects Christoffer Granstedt has been working on.">
      <div className="mx-auto pt-4 px-2 text-xs sm:text-base">
        ...
        <p className="py-4"> More projects I have done will be added, please see my GitHub profile for more projects source codes. I am currently working on a little bigger personal web application project in my spare time where my goal is that the site will go live in Q1 2022. 
